<template>
  <div>
    <!-- 头部组件 -->
<van-nav-bar title="vip" left-text  left-arrow @click-left="onClickLeft" />
    <!-- 会员 -->
    <div class="top">
      <div class="box">
        <img :src="arr.avatar" />
...
<script>
import { vipAjax, userInfo, downOrderAjax } from "../../utils/api";
...
export default {
  ...
  methods: {
    ...
    async pays() {
      let data = await downOrderAjax(this.shop_id,14);
      console.log(data);
      Dialog.confirm({
        title: "提示",
