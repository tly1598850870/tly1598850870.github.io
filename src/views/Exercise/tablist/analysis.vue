<template>
  <div>
    <p class="tly_topsmillbox">
      <span>物理</span
      ><span><span class="tly_blue">0</span><span>/8</span></span>
    </p>
    <div class="tly_conterbox">
      <p class="tly_topp">
        <span class="tly_bluebox">多选</span><span>1</span
        ><span>下列叙述正确的是</span>
      </p>
...
export default {
  ...
  mounted() {
    ...
    this.$store.commit("changerightarrows", true);
